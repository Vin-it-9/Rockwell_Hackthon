...
public class AGV {
    ...
    public void startMoving(int destination, int distance, LocalTime currentTime) {
        ...
        // Battery drains fully in DISCHARGE_TIME minutes
        double consumptionPerUnit = 100.0 / DISCHARGE_TIME;
        double loadFactor = 1.0 + (currentLoad / MAX_CAPACITY); // More load = more battery usage
        double batteryConsumption = distance * consumptionPerUnit * loadFactor;
     ...
     */
    public void completeMoving(int newStation) {
        moving = false;
